...
<a href="https://chromewebstore.google.com/detail/gdajdfngeonjmcclghkmeoacopnnfpnc">
  <img src="docs/showcase/store-hero.webp" alt="腾讯会议录屏下载助手 on the Chrome Web Store — 4.0★ rating, 1,000 users, Manifest V3, showing popup UI with generated curl download command" width="100%">
</a>

<details>
<summary>📋 Store description & rating</summary>

<img src="docs/showcase/store-description.webp" width="100%" alt="Chrome Web Store listing — feature list: auto-detect video links, custom save path, reliable download command generation; 4 stars (5-star scale)">
